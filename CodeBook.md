...
## Description of the data folder and its content

The data that was obtained has the following structure: The main folder, UCI HAR Dataset contains two folders, test and train, and four text files: activity_labels, features, features_info, and README.
